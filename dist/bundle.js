function readImplementation(
  ...
  if (
    (options === null || options === void 0 ? void 0 : options.join) &&
    "sheets" in options.join
  ) {
  ...
  const batchResponse =
    (_c =
      (_b =
        (_a =
          Sheets === null || Sheets === void 0
            ? void 0
            : Sheets.Spreadsheets) === null || _a === void 0
          ? void 0
          : _a.Values) === null || _b === void 0
        ? void 0
        : _b.batchGet) === null || _c === void 0
      ? void 0
      : _c.call(_b, spreadsheetId, {
          ranges: ranges,
          valueRenderOption:
